...
public class UserClient {
    ...
    // Create and initilize UserCacheFactory class object 
    public static UserCacheFactory factory = new UserCacheFactory();
    ...
    public static void DoOperations(String input) {
        ...
        //Create conditions call method according to entered command
        if (splited[0].equals("save")) {
            usercache = factory.getCommand(splited);
            usercache.ExecuteCommand(splited);
            Start();
        } else if (splited[0].equals("findall")) {
            usercache = factory.getCommand(splited);
            usercache.ExecuteCommand(splited);
            Start();
            ...
            usercache.ExecuteCommand(splited);
            Start();
        } else if (splited[0].equals("update")) {
            usercache = factory.getCommand(splited);
            usercache.ExecuteCommand(splited);
            Start();
        }
